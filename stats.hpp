...
// NOTE: no "using namespace std;" in a .hpp file!  That's why we use
// "std::vector instead of "vector" later on.  You can add "using namespace
// std;" to your stats.cpp if you want to.
...
//   }
//
//  This means that the value 1 occurred twice, the value 2 occurred three
//  times, and the value 17 occurred once
